\begin{titlepage}
    \thispagestyle{empty}           % Seiteninformation löschen
    \begin{tikzpicture}[overlay, remember picture]
        % green bar
        \fill [orange]              % rechteckige-Farb-Füllung
        (current page.north west)   % linke, ober Postion
        rectangle                   % shape
        ([xshift=5cm]               % Breite
         current page.south west);  % rechte, untere Position
        % gray bar
        ...
        {\includegraphics[width=11cm,height=8cm]{./pics/me2.jpg}};
        % name and address
